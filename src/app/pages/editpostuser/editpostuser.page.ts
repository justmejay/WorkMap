...
@Component({
  selector: 'app-editpostuser',
  templateUrl: './editpostuser.page.html',
  styleUrls: ['./editpostuser.page.scss'],
})
export class EditpostuserPage implements OnInit {
  post: any = [];
...
async editpost() {
  ...
  if (post) {
    ...
    this.router.navigateByUrl('/mypostuser', { replaceUrl: true });
